...
namespace WhosOnTheDecks.API.Migrations
{
    ...
    [Migration("20200417141235_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WhosOnTheDecks.API.Models.Booking", b =>
                {
                    b.HasOne("WhosOnTheDecks.API.Models.Event", null)
                        .WithMany("Bookings")
                        .HasForeignKey("Booking");

                    b.HasOne("WhosOnTheDecks.API.Models.Dj", null)
                        .WithMany("Bookings")
                        .HasForeignKey("Booking");
            ...
            modelBuilder.Entity("WhosOnTheDecks.API.Models.Event", b =>
                {
                    b.HasOne("WhosOnTheDecks.API.Models.Promoter", null)
                        .WithMany("Events")
                        .HasForeignKey("Event");

                    b.HasOne("WhosOnTheDecks.API.Models.Payment", "Payment")
                        .WithOne()
                        .HasForeignKey("WhosOnTheDecks.API.Models.Event", "PaymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
